...
var chunk_4X6GTOPI_exports = {};
__export(chunk_4X6GTOPI_exports, {
...
module.exports = __toCommonJS(chunk_4X6GTOPI_exports);
...
function lintSchema({ schemas }) {
  const lintResult = import_chunk_2IKVYFVK.prismaSchemaWasm.lint(JSON.stringify(schemas));
