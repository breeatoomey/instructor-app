...
var chunk_XUIWOECY_exports = {};
__export(chunk_XUIWOECY_exports, {
  getEnginesInfo: () => getEnginesInfo,
  getEnginesMetaInfo: () => getEnginesMetaInfo,
  resolveEngine: () => resolveEngine
});
module.exports = __toCommonJS(chunk_XUIWOECY_exports);
var import_chunk_NZ262BVM = require("./chunk-NZ262BVM.js");
var import_chunk_NWGZKN7E = require("./chunk-NWGZKN7E.js");
var import_chunk_N6KD56ZU = require("./chunk-N6KD56ZU.js");
...
async function resolveEngine(binaryName) {
  ...
  const enginePathEither = await (0, import_function2.pipe)(
    pathFromEnvOption,
    fold(
      () => (0, import_chunk_N6KD56ZU.safeResolveBinary)(binaryName),
  ...
  const versionEither = await (0, import_function2.pipe)(
    ...
    (0, import_chunk_6QRPFUVD.chain)((enginePath) => {
      return (0, import_chunk_NWGZKN7E.safeGetEngineVersion)(enginePath, binaryName);
    })
  )();
  const engineInfo = {
