...
var chunk_A2RXZWMF_exports = {};
__export(chunk_A2RXZWMF_exports, {
  handleLibraryLoadingErrors: () => handleLibraryLoadingErrors
});
module.exports = __toCommonJS(chunk_A2RXZWMF_exports);
...
function handleLibraryLoadingErrors(args) {
  ...
  const potentialReasonMessage = (0, import_chunk_IKGYNTE3.$)({ message: error.message, code: error.code }).with({ code: "ENOENT" }, () => `File does not exist.`).when(
