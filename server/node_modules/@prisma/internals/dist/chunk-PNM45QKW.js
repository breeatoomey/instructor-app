...
var chunk_PNM45QKW_exports = {};
__export(chunk_PNM45QKW_exports, {
  MergeSchemasError: () => MergeSchemasError,
  mergeSchemas: () => mergeSchemas
});
module.exports = __toCommonJS(chunk_PNM45QKW_exports);
...
function mergeSchemas(options) {
  const debugErrorType = (0, import_chunk_G2BFX4VJ.createDebugErrorType)(debug, "mergeSchemasWasm");
  ...
  const mergeSchemasEither = (0, import_function.pipe)(
    (0, import_chunk_6QRPFUVD.tryCatch)(
      () => {
        ...
        return import_chunk_2IKVYFVK.prismaSchemaWasm.merge_schemas(params);
      },
      (e) => ({
        type: "wasm-error",
  ...
  if ((0, import_chunk_6QRPFUVD.isRight)(mergeSchemasEither)) {
    return mergeSchemasEither.right;
  }
  const error = (0, import_chunk_IKGYNTE3.$)(mergeSchemasEither.left).with({ type: "wasm-error" }, (e) => {
    debugErrorType(e);
    console.error("");
    if ((0, import_chunk_A4QWQE3W.isWasmPanic)(e.error)) {
      ...
      const panic = new import_chunk_A4QWQE3W.RustPanic(
        ...
        "FMT_CLI",
        /* schemaPath */
        (0, import_chunk_URGOXRQA.debugMultipleSchemaPaths)(options.schemas),
        /* schema */
        (0, import_chunk_URGOXRQA.debugMultipleSchemas)(options.schemas)
      );
      return panic;
    }
    const errorOutput = e.error.message;
    return new MergeSchemasError((0, import_chunk_G2BFX4VJ.parseQueryEngineError)({ errorOutput, reason: e.reason }));
  }).exhaustive();
  throw error;
}
