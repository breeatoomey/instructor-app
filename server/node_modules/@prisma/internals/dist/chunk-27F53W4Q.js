...
var chunk_27F53W4Q_exports = {};
__export2(chunk_27F53W4Q_exports, {
  sendPanic: () => sendPanic
});
module.exports = __toCommonJS2(chunk_27F53W4Q_exports);
...
var require_polyfills = (0, import_chunk_CTBG5EFY.__commonJS)({
  "../../node_modules/.pnpm/graceful-fs@4.2.11/node_modules/graceful-fs/polyfills.js"(exports2, module2) {
    "use strict";
    var constants2 = (0, import_chunk_CTBG5EFY.__require)("constants");
    ...
    if (!fs3[gracefulQueue]) {
      ...
      if (/\bgfs4\b/i.test(process.env.NODE_DEBUG || "")) {
        process.on("exit", function() {
          ...
          (0, import_chunk_CTBG5EFY.__require)("assert").equal(fs3[gracefulQueue].length, 0);
        });
      }
    }
    var queue2;
