...
var chunk_RTZPK3QW_exports = {};
__export(chunk_RTZPK3QW_exports, {
  handlePanic: () => handlePanic
});
module.exports = __toCommonJS(chunk_RTZPK3QW_exports);
...
var import_chunk_XBE2OCEA = require("./chunk-XBE2OCEA.js");
...
`);
  ...
  if (shouldSubmitReport) {
    try {
      ...
      const reportId = await (0, import_chunk_XBE2OCEA.sendPanic)({ error, cliVersion, enginesVersion, getDatabaseVersionSafe });
      console.log(`
