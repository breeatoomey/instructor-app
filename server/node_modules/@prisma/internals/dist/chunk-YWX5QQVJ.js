...
var chunk_YWX5QQVJ_exports = {};
__export(chunk_YWX5QQVJ_exports, {
  GetDmmfError: () => GetDmmfError,
  getDMMF: () => getDMMF
});
module.exports = __toCommonJS(chunk_YWX5QQVJ_exports);
var import_chunk_URGOXRQA = require("./chunk-URGOXRQA.js");
var import_chunk_G2BFX4VJ = require("./chunk-G2BFX4VJ.js");
var import_chunk_HO25CWRL = require("./chunk-HO25CWRL.js");
...
var GetDmmfError = class extends Error {
  constructor(params) {
    const constructedErrorMessage = (0, import_chunk_IKGYNTE3.$)(params).with({ _tag: "parsed" }, ({ errorCode, message, reason }) => {
...
[Context: getDmmf]`;
    super((0, import_chunk_HO25CWRL.addVersionDetailsToErrorMessage)(errorMessageWithContext));
    this.name = "GetDmmfError";
  }
};
async function getDMMF(options) {
  warnOnDeprecatedFeatureFlag(options.previewFeatures);
  const debugErrorType = (0, import_chunk_G2BFX4VJ.createDebugErrorType)(debug, "getDmmfWasm");
  debug(`Using getDmmf Wasm`);
  const dmmfPipeline = (0, import_function.pipe)(
    (0, import_chunk_6QRPFUVD.tryCatch2)(
      () => {
    ...
    (0, import_chunk_6QRPFUVD.chainW2)((datamodel) => {
      return (0, import_function.pipe)(
        (0, import_chunk_6QRPFUVD.tryCatch)(
          () => {
            ...
            const data = import_chunk_2IKVYFVK.prismaSchemaWasm.get_dmmf(params);
            return data;
          },
          (e) => ({
            type: "wasm-error",
        ...
        (0, import_chunk_6QRPFUVD.map)((result) => ({ result })),
        (0, import_chunk_6QRPFUVD.chainW)(
          ({ result }) => (
  ...
  if ((0, import_chunk_6QRPFUVD.isRight)(dmmfEither)) {
    debug("dmmf data retrieved without errors in getDmmf Wasm");
    const { right: data } = dmmfEither;
    return Promise.resolve(data);
  }
  const error = (0, import_chunk_IKGYNTE3.$)(dmmfEither.left).with({ type: "read-datamodel-path" }, (e) => {
    debugErrorType(e);
...
Datamodel path: "${e.datamodelPath}"`,
    ...
    if ((0, import_chunk_A4QWQE3W.isWasmPanic)(e.error)) {
      ...
      const panic = new import_chunk_A4QWQE3W.RustPanic(
        ...
        options.prismaPath,
        /* schema */
        (0, import_chunk_URGOXRQA.schemaToStringDebug)(options.datamodel)
      );
      return panic;
    }
    const errorOutput = e.error.message;
    return new GetDmmfError((0, import_chunk_G2BFX4VJ.parseQueryEngineError)({ errorOutput, reason: e.reason }));
