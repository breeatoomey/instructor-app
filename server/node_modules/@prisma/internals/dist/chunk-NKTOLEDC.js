...
var chunk_NKTOLEDC_exports = {};
__export(chunk_NKTOLEDC_exports, {
  MergeSchemasError: () => MergeSchemasError,
  mergeSchemas: () => mergeSchemas
});
module.exports = __toCommonJS(chunk_NKTOLEDC_exports);
...
[Context: mergeSchemas]`;
    super((0, import_chunk_7UL2RDID.addVersionDetailsToErrorMessage)(errorMessageWithContext));
  ...
  const mergeSchemasEither = (0, import_function.pipe)(
    (0, import_chunk_6QRPFUVD.tryCatch)(
      () => {
        ...
        return import_chunk_7SZOUC3T.prismaSchemaWasm.merge_schemas(params);
      },
      (e) => ({
        type: "wasm-error",
