...
exports.expectSemanticToken = exports.highlightHelper = exports.clearDocuments = exports.expectWarning = exports.expectError = exports.expectIssue = exports.expectNoIssues = exports.filterByOptions = exports.rangeToString = exports.isRangeEqual = exports.validationHelper = exports.replaceIndices = exports.parseDocument = exports.textDocumentPositionParams = exports.expectFormatting = exports.expectHover = exports.referenceParams = exports.expectFindReferences = exports.expectGoToDefinition = exports.expectCompletion = exports.textDocumentParams = exports.expectFoldings = exports.expectWorkspaceSymbols = exports.expectSymbols = exports.expectHighlight = exports.expectFunction = exports.parseHelper = void 0;
...
function parseHelper(services) {
    ...
    return async (input, options) => {
        ...
        const uri = vscode_uri_1.URI.parse((_a = options === null || options === void 0 ? void 0 : options.documentUri) !== null && _a !== void 0 ? _a : `file:///${randomNumber}${metaData.fileExtensions[0]}`);
...
let expectedFunction = (actual, expected, message) => {
    assert_1.default.deepStrictEqual(actual, expected, message);
};
/**
 ...
 */
function expectHighlight(services) {
    return async (input) => {
        var _a, _b;
...
exports.expectHighlight = expectHighlight;
...
function expectWorkspaceSymbols(services) {
    return async (input) => {
        var _a, _b, _c;
...
exports.expectWorkspaceSymbols = expectWorkspaceSymbols;
...
exports.textDocumentParams = textDocumentParams;
...
exports.referenceParams = referenceParams;
...
exports.textDocumentPositionParams = textDocumentPositionParams;
...
function filterByOptions(validationResult, options) {
    ...
    if ('node' in options && options.node) {
        ...
        if (options.property) {
            ...
            cstNode = (0, grammar_util_1.findNodeForProperty)(cstNode, name, index);
        }
        if (!cstNode) {
...
exports.filterByOptions = filterByOptions;
...
function highlightHelper(services) {
    ...
    return async (text) => {
        ...
        const tokens = await tokenProvider.semanticHighlight(document, params, new vscode_languageserver_1.CancellationTokenSource().token);
