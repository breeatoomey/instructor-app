...
import type { LangiumDocument, LangiumDocuments, PrecomputedScopes } from '../../workspace/documents';
...
export declare class LangiumGrammarScopeComputation extends DefaultScopeComputation {
    ...
    protected createInterfaceDescription(node: AstNode, name: string, document?: LangiumDocument): AstNodeDescription;
}
