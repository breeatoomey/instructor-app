...
exports.LangiumCompletionParser = exports.LangiumParserErrorMessageProvider = exports.AbstractParserErrorMessageProvider = exports.LangiumParser = exports.AbstractLangiumParser = exports.DatatypeSymbol = void 0;
const chevrotain_1 = require("chevrotain");
const chevrotain_allstar_1 = require("chevrotain-allstar");
...
class AbstractParserErrorMessageProvider {
    buildMismatchTokenMessage(options) {
        return chevrotain_1.defaultParserErrorProvider.buildMismatchTokenMessage(options);
    }
    buildNotAllInputParsedMessage(options) {
        return chevrotain_1.defaultParserErrorProvider.buildNotAllInputParsedMessage(options);
    }
...
exports.AbstractParserErrorMessageProvider = AbstractParserErrorMessageProvider;
