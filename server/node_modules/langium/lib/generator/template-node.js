    ...
    const result = splitAndMerged.reduce((res, segment, i) => isUndefinedSegmentMarker(segment)
        ...
        : isNewLineMarker(segment)
            ? {
                ...
                node: i !== 0 && (isUndefinedSegmentMarker(splitAndMerged[i - 1]) || (0, generator_node_1.isGeneratorNode)(splitAndMerged[i - 1]))
                    || i > 1 && typeof splitAndMerged[i - 1] === 'string' && (isUndefinedSegmentMarker(splitAndMerged[i - 2]) || (0, generator_node_1.isGeneratorNode)(splitAndMerged[i - 2]))
