...
const completion_provider_1 = require("./completion/completion-provider");
...
function addWorkspaceSymbolHandler(connection, services) {
    var _a;
...
exports.addWorkspaceSymbolHandler = addWorkspaceSymbolHandler;
